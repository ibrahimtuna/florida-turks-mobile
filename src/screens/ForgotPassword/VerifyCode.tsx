  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {t('forgot_password.verify_code_title', {
        ...
        >
          ...
          >
            {t('forgot_password.recover_code')}
          </Text>
          <TextInput
            placeholder={t('forgot_password.recover_code')}
        ...
        >
          ...
          <TouchableOpacity
            activeOpacity={0.8}
            onPress={() => navigation.navigate('ForgotPasswordNewPass')}
            style={{
              borderWidth: 1,
              borderColor: '#E40E1A',
